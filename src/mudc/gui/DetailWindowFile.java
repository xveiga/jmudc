...
public class DetailWindowFile extends JDialog {

	private final JPanel contentPanel = new JPanel();
	private JLabel lblDetails;

	public DetailWindowFile(MoodleElement element) {
		...
		}
		{
			...
			textPane.setText("Filename: " + element.filename +
					"\nMoodle path: " + element.filepath +
					"\nLocal path: " + element.localPath +
					...
					"\nCreated: " + element.timecreated +
					"\nModified: " + element.timemodified +
					"\nType: " + element.type +
