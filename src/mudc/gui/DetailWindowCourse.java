...
public class DetailWindowCourse extends JDialog {

	private final JPanel contentPanel = new JPanel();
	private JLabel lblDetails;

	public DetailWindowCourse(MoodleCourse course) {
		...
		}
		{
			...
			textPane.setText("Short name: " + course.shortname +
					"\nFull name: " + course.fullname +
					"\nID: " + course.id +
					"\nID number: " + course.idnumber +
					"\nLang: " + course.lang +
					"\nEnrolled users: " + course.enrolledusercount +
					"\nFormat: " + course.format +
					"\nSummary: " + course.summary +
					"\nSummary format: " + course.summaryformat +
					"\nVisible: " + course.visible +
					"\nShow grades: " + course.showgrades +
					"\nEnable completion: " + course.enablecompletion
					);
